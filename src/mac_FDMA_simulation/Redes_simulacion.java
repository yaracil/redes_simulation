    ...
    public static void main(String[] args) {
        ...
        for (double k = 0.5; k <= cant_clientes; k += paso, i++) {
            ...
            dataTiempoSistema[2][t2] = "Probabilidad teórica tamaño variable";
                        ...
                        // graficas II
            dataOcupacionTVariab[0][i] = simulacionTamVariable.getReal_E_n();
            dataOcupacionTVariab[1][i] = k;
            dataOcupacionTVariab[2][i] = "Probabilidad real tamaño variable";

            dataOcupacionTVariab[0][t] = simulacionTamVariable.getTeoric_E_n();
            dataOcupacionTVariab[1][t] = k;
            dataOcupacionTVariab[2][t] = "Probabilidad teórica tamaño variable";

            dataTiempoSistemaTVariab[0][i] = simulacionTamVariable.getReal_TPsistema();
            dataTiempoSistemaTVariab[1][i] = k;
            dataTiempoSistemaTVariab[2][i] = "Probabilidad real tamaño variable";

            dataTiempoSistemaTVariab[0][t] = simulacionTamVariable.getTeoric_TPsistema();
            dataTiempoSistemaTVariab[1][t] = k;
            dataTiempoSistemaTVariab[2][t] = "Probabilidad teórica tamaño variable";

            dataTiempoColaTVariab[0][i] = simulacionTamVariable.getRealTPcola();
            dataTiempoColaTVariab[1][i] = k;
            dataTiempoColaTVariab[2][i] = "Probabilidad real tamaño variable";            
            
            dataTiempoColaTVariab[0][t] = simulacionTamVariable.getTeoric_TPcola();
            dataTiempoColaTVariab[1][t] = k;
            dataTiempoColaTVariab[2][t] = "Probabilidad teórica tamaño variable";
